                ...
                <div className='flex flex-col flex-grow justify-end gap-8'>
                    ...
                    <div ref={brochureRef} className='w-full flex flex-col items-center'>
                        ...
                        <div className='flex flex-col text-3xl gap-4 md:gap-2'>
                            <div className='overflow-hidden rounded cursor-pointer'><a id="borga-catalogue-side" href="/pdf/borga.pdf"><Image src="/images/borga.png" width={100} height={0} /></a></div>
                            <div className='overflow-hidden rounded cursor-pointer'><a id="magiline-catalogue-side" href="/pdf/magiline.pdf"><Image src="/images/magiline.png" width={100} height={0} /></a></div>
                        </div>
                    </div>
                    {/* Seleziona lingua */}
